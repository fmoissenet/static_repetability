...
% Date         : October 2021
% -------------------------------------------------------------------------
% Description  : Initialise Marker structure with raw trajectories
% -------------------------------------------------------------------------
% Dependencies : None
% -------------------------------------------------------------------------
...
markerSet = {'RASI','RPSI','LPSI','LASI',...
             'RGTR','RTHAP','RTHAD','RTHI','RKNE','RKNM',...
             'RFAX','RTTA','RTIAP','RTIAD','RTIB','RANK','RMED',...
             'RHEE','RTOE','RFMH','RSMH','RVMH',...
             'LGTR','LTHAP','LTHAD','LTHI','LKNE','LKNM',...
             'LFAX','LTTA','LTIAP','LTIAD','LTIB','LANK','LMED',...
